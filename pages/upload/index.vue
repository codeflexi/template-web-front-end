          ...
          <div class="mt-8 md:flex gap-6">
              ...
              <div class="mt-4 mb-6">
                  ...
                  <div calss=" mt-5 ">
                    ...
                    <input type="date" class="px-4 py-3 rounded-xl border-2 max-w-full" v-model="form_input.deliveryDate">
                  </div>
...
onMounted(()=>{
 // form_input.value.deliveryDate = Date.now()
})
...
const createPost = async () => {
  ...
  data.append('description', caption.value || '')
