<template>
  ...
  >
    <div class="lg:w-full w-[55px] mx-auto">
      ...
      <MenuItem iconString="Customers" colorString="#000000" sizeString="27" />
      <MenuItem iconString="Vedio" colorString="#000000" sizeString="27" />
      ...
      <div class="lg:block hidden text-[11px] text-gray-500">
        <div class="pt-4 px-2">
          About Newsroom NKSuit Shop Contact Careers ByteDance
        </div>
        <div class="pt-4 px-2">
          NKSuit for Good Advertise Developers Transparency NKSuit Rewards
          NKSuit Browse NKSuit Embeds
        </div>
        <div class="pt-4 px-2">
          Help Safety Terms Privacy Creator Portal Community Guidelines
        </div>
        <div class="pt-4 px-2">© 2023 NKSuit</div>
      </div>
